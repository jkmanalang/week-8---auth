...
void main() {
  ...
  group('end-to-end test', () {
    testWidgets('Test Signup button', (tester) async {
      app.main();
      await tester
          .pumpAndSettle(); // wait to generate things. wait to build widget tree. click buttons, user inputs etc.
...
// verify that the Text widgets and Button widgets appear exactly once in the widget tree.
      ...
      await tester.pumpAndSettle(); // wait for sign up screen to load again
